...
exports.default = {
  name: 'Paragraph',
  summary: '<p> element represents a paragraph. Paragraph are usually represented in visual media as blocks of text separated from adjacent blocks by blank lines and/or first-line indentation, but HTML Paragraph can be any structural grouping of related content, such as images or form fields.',
  import: '',
  withStyles: true,
  stories: [{
    name: 'Basic',
