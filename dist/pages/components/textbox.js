...
var _textbox = require('../../stories/mock/components/stories/textbox');

var _textbox2 = _interopRequireDefault(_textbox);

var _map = require('../../components/TextBox/map.json');
  ...
  _createClass(ComponentView, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _textbox2.default && _react2.default.createElement(_DetailsComponent2.default, {
          name: _textbox2.default.name,
          linkGithub: 'https://github.com/front10/landing-page-book/tree/master/src/components/TextBox',
          description: _textbox2.default.summary,
          stories: _textbox2.default.stories,
          importCode: _textbox2.default.import,
          withStyles: _textbox2.default.withStyles,
          extractProps: _textbox2.default.extractProps,
