...
var _navbar = require('../../stories/mock/components/stories/navbar');

var _navbar2 = _interopRequireDefault(_navbar);

var _map = require('../../components/Navbar/map.json');
  ...
  _createClass(ComponentView, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _navbar2.default && _react2.default.createElement(_DetailsComponent2.default, {
          name: _navbar2.default.name,
          linkGithub: 'https://github.com/front10/landing-page-book/tree/master/src/components/Navbar',
          description: _navbar2.default.summary,
          stories: _navbar2.default.stories,
          importCode: _navbar2.default.import,
          withStyles: _navbar2.default.withStyles,
          extractProps: _navbar2.default.extractProps,
