...
var _label = require('../../stories/mock/components/stories/label');

var _label2 = _interopRequireDefault(_label);

var _map = require('../../components/Label/map.json');
  ...
  _createClass(ComponentView, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _label2.default && _react2.default.createElement(_DetailsComponent2.default, {
          name: _label2.default.name,
          linkGithub: 'https://github.com/front10/landing-page-book/tree/master/src/components/Label',
          description: _label2.default.summary,
          stories: _label2.default.stories,
          importCode: _label2.default.import,
          withStyles: _label2.default.withStyles,
          extractProps: _label2.default.extractProps,
