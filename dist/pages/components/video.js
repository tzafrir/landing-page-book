...
var _video = require('../../stories/mock/components/stories/video');

var _video2 = _interopRequireDefault(_video);

var _map = require('../../components/Video/map.json');
  ...
  _createClass(ComponentView, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _video2.default && _react2.default.createElement(_DetailsComponent2.default, {
          name: _video2.default.name,
          linkGithub: 'https://github.com/front10/landing-page-book/tree/master/src/components/Video',
          description: _video2.default.summary,
          stories: _video2.default.stories,
          importCode: _video2.default.import,
          withStyles: _video2.default.withStyles,
          extractProps: _video2.default.extractProps,
