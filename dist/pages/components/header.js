...
var _header = require('../../stories/mock/components/stories/header');

var _header2 = _interopRequireDefault(_header);

var _map = require('../../components/Header/map.json');
  ...
  _createClass(ComponentView, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _header2.default && _react2.default.createElement(_DetailsComponent2.default, {
          name: _header2.default.name,
          linkGithub: 'https://github.com/front10/landing-page-book/tree/master/src/components/Header',
          description: _header2.default.summary,
          stories: _header2.default.stories,
          importCode: _header2.default.import,
          withStyles: _header2.default.withStyles,
          extractProps: _header2.default.extractProps,
