...
var _code = require('../../stories/mock/components/stories/code');

var _code2 = _interopRequireDefault(_code);

var _map = require('../../components/Code/map.json');
  ...
  _createClass(ComponentView, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _code2.default && _react2.default.createElement(_DetailsComponent2.default, {
          name: _code2.default.name,
          linkGithub: 'https://github.com/front10/landing-page-book/tree/master/src/components/Code',
          description: _code2.default.summary,
          stories: _code2.default.stories,
          importCode: _code2.default.import,
          withStyles: _code2.default.withStyles,
          extractProps: _code2.default.extractProps,
